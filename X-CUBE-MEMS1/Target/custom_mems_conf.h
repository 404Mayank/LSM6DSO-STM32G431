...
#define CUSTOM_LSM6DSO_0_SPI_Init BSP_SPI1_Init
#define CUSTOM_LSM6DSO_0_SPI_DeInit BSP_SPI1_DeInit
#define CUSTOM_LSM6DSO_0_SPI_Send BSP_SPI1_Send
#define CUSTOM_LSM6DSO_0_SPI_Recv BSP_SPI1_Recv

#define CUSTOM_LSM6DSO_0_CS_PORT GPIOA
#define CUSTOM_LSM6DSO_0_CS_PIN GPIO_PIN_4
